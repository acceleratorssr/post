...
type TagServiceClient interface {
	...
	GetBizTags(ctx context.Context, in *GetObjTagsRequest, opts ...grpc.CallOption) (*GetObjTagsResponse, error)
}
...
func (c *tagServiceClient) GetBizTags(ctx context.Context, in *GetObjTagsRequest, opts ...grpc.CallOption) (*GetObjTagsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TagServiceServer interface {
	...
	GetBizTags(context.Context, *GetObjTagsRequest) (*GetObjTagsResponse, error)
...
func (UnimplementedTagServiceServer) GetBizTags(context.Context, *GetObjTagsRequest) (*GetObjTagsResponse, error) {
...
func _TagService_GetBizTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).GetBizTags(ctx, req.(*GetObjTagsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
