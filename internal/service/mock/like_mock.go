...
func (m *MockLikeService) GetListBatchOfLikes(ctx context.Context, ObjType string, offset, limit int, now int64) ([]domain.Like, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetListBatchOfLikes", ctx, ObjType, offset, limit, now)
...
func (mr *MockLikeServiceMockRecorder) GetListBatchOfLikes(ctx, ObjType, offset, limit, now any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetListBatchOfLikes", reflect.TypeOf((*MockLikeService)(nil).GetListBatchOfLikes), ctx, ObjType, offset, limit, now)
}
